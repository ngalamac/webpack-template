...
This template includes webpack and its configuration files. The purpose of this template was to setup an environment where developers can use inorder to build their project with webpack.

**[Webpack template]** is an HTML, CSS and Javascript template done as an assignment while studying at Microverse.
...
```sh
  ...
  git clone https://github.com/ngalamac/webpack-template.git
```
